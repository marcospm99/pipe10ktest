...
!-------------------------------------------------------------------------
   ...
   use wksp, only: p4
      ...
      call tra_spec2phys(s2, p2, p4%Re)
      call tra_spec2phys(s3, p3, p4%Re)
...
!-------------------------------------------------------------------------
   ...
   use wksp, only: p4
      ...
      call tra_phys2spec(p3, s3,p4%Re)
...
!------------------------------------------------------------------------
   subroutine tra_spec2phys(s, p, Ts)
   use wksp, only: p4
      implicit none
...
!------------------------------------------------------------------------
   subroutine tra_phys2spec(p, s, Ts)
   use wksp, only: p4
      implicit none
      type (phys), intent (in)  :: p
